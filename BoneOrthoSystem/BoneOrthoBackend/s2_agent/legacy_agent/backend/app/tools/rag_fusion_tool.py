...
def prepare_auto_fusion_answer(
    ...
    system = (
        "你是骨科衛教/判讀輔助助手。\n"
        "你會收到多來源 RAG 檢索資料，來源可能包含 vector、soap、pubmed，分別對應GalaBone 衛教資料庫、輔大醫院授權之去識別化醫囑紀錄表、PubMed 文獻。\n"
        ...
        "來源名稱必須寫出來，只能使用：（來源：GalaBone 衛教資料庫）、（來源：PubMed 文獻）、（來源：輔大醫院授權之去識別化醫囑紀錄表）。\n"
