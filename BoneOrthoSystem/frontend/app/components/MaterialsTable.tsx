...
export default function MaterialsTable() {
          ...
          <div className="flex items-center gap-2">
            <div className="relative w-full">
              <input
                ...
                disabled={!isLoggedIn}
                className="h-9 w-full rounded-xl border border-slate-300 bg-white px-3 pr-9 text-slate-800
 ...
 p-0 m-0 bg-transparent border-0 outline-none shadow-none
 focus:outline-none focus:ring-0"                >
    ...
    disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="mt-4 w-full min-w-0 max-w-full overflow-x-auto 
        ...
        <table className="materials-table min-w-[820px] w-full text-xs">
          <thead className="bg-slate-50 text-slate-600 border-b border-slate-200
            ...
            <tr>
              ...
              <th className="sticky right-0 z-10 bg-slate-50 dark:bg-slate-800 px-4 py-3 text-center text-xs font-semibold whitespace-nowrap ">
                操作
              </th>
            </tr>
          </thead>
        ...
        <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="pagination-btn px-3 py-1.5 rounded-lg border border-slate-300 text-xs text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-800"
              title="第一頁"
            >
