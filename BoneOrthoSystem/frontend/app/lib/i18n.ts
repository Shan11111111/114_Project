...
2. 小罐頭是用來學習和輔助說明的，醫療決策還是要和醫療專業人員討論後再做出喔。`,
    ...
    "bonevision.readyTitle": "準備開始骨骼辨識",
    "bonevision.readyDesc1":
      "上傳 X 光影像後，點選「開始辨識（模型）」即可查看 AI 標註結果。",
    "bonevision.readyDesc2":
      "建議使用清晰、骨骼區域完整入鏡的影像；也可以先用左側的「查看範例影像庫」體驗流程。",
    "bonevision.noBoneTitle": "這張影像沒有辨識出骨骼",
    "bonevision.noBoneDesc1":
      "可能是影像不夠清晰、骨骼區域被裁切，或圖片內容不是系統目前支援的 X 光骨骼類型。",
    "bonevision.noBoneDesc2":
      "建議換一張骨骼更完整、對比更明顯的 X 光影像，或先使用範例影像庫確認辨識流程。",
    "bonevision.tipChangeImage": "請更換圖片",
    "bonevision.tipUploadDetect": "上傳後開始辨識",
    "bonevision.tipClearXray": "清晰 X 光",
    "bonevision.tipFullBone": "骨骼完整入鏡",
    "bonevision.tipUseSamples": "可使用範例影像",
    "bonevision.quizTitle": "整張 X 光影像測驗",
    "bonevision.quizDesc":
      "根據目前影像中的所有辨識框，自動產生互動式選擇題。",
    "bonevision.loadingQuiz": "載入測驗...",
    "bonevision.startQuiz": "開始測驗",
    "bonevision.quizTag": "骨骼測驗",
    "bonevision.correct": "正確",
    "bonevision.wrong": "錯誤",
    "bonevision.correctMessage": "答對了！",
    "bonevision.wrongAnswer": "答錯了",
    "bonevision.correctAnswer": "正確答案",
    "bonevision.explanation": "說明",
    "bonevision.close": "關閉",
    "bonevision.finishQuiz": "完成測驗",
    "bonevision.nextQuestion": "下一題",
    "bonevision.quizCompleted": "測驗完成",
    "bonevision.score": "得分",
    "bonevision.finish": "完成",
    "bonevision.question": "題目",
    "bonevision.quizModalTitle": "骨骼辨識測驗",

    //*辨識頁面歷史紀錄 */
    "bonevision.loginRequiredHistory": "請先登入或註冊後查看歷史紀錄",
    "bonevision.loginRequiredHistoryDesc": "登入後即可查看個人辨識歷程與後續紀錄",
    "bonevision.goLogin": "前往登入",
    "bonevision.goRegister": "前往註冊",
    "bonevision.loading": "載入中...",
    "bonevision.noHistory": "尚無歷史紀錄",
    "bonevision.case": "案例",
    "bonevision.loadingDetail": "載入詳細資料中...",
    "bonevision.backToDetection": "回到辨識",
    "bonevision.delete": "刪除",
    "bonevision.imagePreview": "影像預覽",
    "bonevision.detectionItems": "辨識項目",
    "bonevision.noDetectionInRecord": "這筆紀錄沒有 detection。",
    "bonevision.historyTitle": "歷史紀錄",
    "bonevision.historySubtitle": "查看個人辨識歷程與後續紀錄",
    "bonevision.searchHistory": "搜尋歷史紀錄",
    "bonevision.detectCount": "偵測數量",
    "bonevision.selectHistory": "請從左側選擇一筆歷史紀錄",
    "bonevision.pressEscToClose": "按 ESC 可關閉",
    "bonevision.all": "全部",
    "bonevision.sampleLoadFailed": "範例影像庫載入失敗",
    "bonevision.invalidUserId": "目前登入資訊中沒有可用的數字 user_id",
    "bonevision.invalidLoginState": "登入狀態異常，請重新登入",
    "bonevision.confirmDeleteHistory": "確定要刪除這筆歷史紀錄嗎？",
    "bonevision.deleteSuccess": "刪除成功",
    "bonevision.selectImageFirst": "請先選擇 X 光圖片",
    "bonevision.noQuizData": "目前沒有可測驗的辨識結果",
    "bonevision.selectDetectionBox": "請從上方選擇一個偵測框，這裡會顯示該部位的資料。",


    //*辨識頁面範例影像庫 - 搜尋*/
    "bonevision.search": "搜尋",
    "bonevision.clear": "清除",
    "bonevision.noMatchedSamples": "查無符合的範例影像，請改用骨骼名稱、英文名稱或分類按鈕搜尋。",
    "bonevision.noSamplesInCategory": "目前這個分類尚無範例影像",
    "bonevision.uncategorized": "未分類",
    "bonevision.noEnglishName": "未提供英文名稱",
    "bonevision.noRegion": "未分類區域",
    "bonevision.noDescription": "目前無描述",
    "bonevision.exampleLibrary": "範例影像庫",
    "bonevision.exampleLibraryDesc": "可直接使用該部位影像進行辨識，或下載到本機",
    "bonevision.searchExamplePlaceholder": "可搜尋骨骼中文名稱、英文名稱、部位或口語描述",
    "bonevision.searchExampleHint": "可搜尋目前範例影像庫中的骨骼中文名稱、英文名稱或部位。",
    "bonevision.useThisImage": "使用此影像",
    "bonevision.downloadImage": "下載影像",
    "bonevision.sampleDetectFailed": "使用範例圖片辨識失敗"
...
5. Feedback is welcome.`,
    ...
    "bonevision.readyTitle": "Ready to Start Bone Detection",
    "bonevision.readyDesc1":
      "Upload an X-ray image and click “Start Detection” to view AI annotation results.",
    "bonevision.readyDesc2":
      "For better results, use clear X-ray images with the full bone region visible. You can also try the sample gallery first.",

    "bonevision.noBoneTitle": "No Bones Detected in This Image",
    "bonevision.noBoneDesc1":
      "The image may be unclear, cropped, or not currently supported by the system.",
    "bonevision.noBoneDesc2":
      "Try another X-ray image with clearer bone structures or use the sample gallery to test the workflow.",

    "bonevision.tipChangeImage": "Change Image",
    "bonevision.tipUploadDetect": "Upload & Detect",
    "bonevision.tipClearXray": "Clear X-ray",
    "bonevision.tipFullBone": "Full Bone Visible",
    "bonevision.tipUseSamples": "Sample Images Available",
    "bonevision.quizTitle": "Full X-ray Quiz",
    "bonevision.quizDesc":
      "Automatically generate interactive multiple-choice questions based on all detected regions in the current image.",
    "bonevision.loadingQuiz": "Loading Quiz...",
    "bonevision.startQuiz": "Start Quiz",
    "bonevision.quizTag": "Bone Quiz",
    "bonevision.correct": "Correct",
    "bonevision.wrong": "Wrong",
    "bonevision.correctMessage": "Correct!",
    "bonevision.wrongAnswer": "Incorrect",
    "bonevision.correctAnswer": "Correct Answer",
    "bonevision.explanation": "Explanation",
    "bonevision.close": "Close",
    "bonevision.finishQuiz": "Finish Quiz",
    "bonevision.nextQuestion": "Next",
    "bonevision.quizCompleted": "Quiz Completed",
    "bonevision.score": "Score",
    "bonevision.finish": "Done",
    "bonevision.question": "Question",
    "bonevision.quizModalTitle": "Bone Detection Quiz",
    "bonevision.all": "All",


    /*辨識頁面歷史紀錄 */
    "bonevision.loginRequiredHistory": "Please log in or register to view history",
    "bonevision.loginRequiredHistoryDesc": "After logging in, you can view your detection history and follow-up records",
    "bonevision.goLogin": "Go to Login",
    "bonevision.goRegister": "Go to Register",
    "bonevision.loading": "Loading...",
    "bonevision.noHistory": "No history records yet",
    "bonevision.case": "Case",
    "bonevision.loadingDetail": "Loading details...",
    "bonevision.backToDetection": "Back to Detection",
    "bonevision.delete": "Delete",
    "bonevision.imagePreview": "Image Preview",
    "bonevision.detectionItems": "Detection Items",
    "bonevision.noDetectionInRecord": "This record has no detections.",
    "bonevision.historyTitle": "History Records",
    "bonevision.historySubtitle": "View your detection history and follow-up records",
    "bonevision.searchHistory": "Search history",
    "bonevision.detectCount": "Detected Count",
    "bonevision.selectHistory": "Select a history record from the left",
    "bonevision.pressEscToClose": "Press ESC to close",


    /*範例影像庫*/
    "bonevision.search": "Search",
    "bonevision.clear": "Clear",
    "bonevision.noMatchedSamples": "No matching sample images found. Try searching by bone name, English name, or category.",
    "bonevision.noSamplesInCategory": "No sample images in this category yet",
    "bonevision.uncategorized": "Uncategorized",
    ...
    "bonevision.useThisImage": "Use Image",
    "bonevision.downloadImage": "Download Image",
    "bonevision.sampleLoadFailed": "Failed to load sample image library",
    "bonevision.invalidUserId": "No valid numeric user_id found in the current login information",
    "bonevision.invalidLoginState": "Login status is invalid. Please log in again.",
    "bonevision.confirmDeleteHistory": "Are you sure you want to delete this history record?",
    "bonevision.deleteSuccess": "Deleted successfully",
    "bonevision.selectImageFirst": "Please select an X-ray image first",
    "bonevision.noQuizData": "There are no detection results available for a quiz",
    "bonevision.selectDetectionBox": "Select a detection box above to view its details.",
    "bonevision.sampleDetectFailed": "Failed to detect sample image"
